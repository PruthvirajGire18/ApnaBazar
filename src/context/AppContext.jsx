...
// If VITE_BACKEND_URL is set in .env, use that, otherwise use default deployed URL
axios.defaults.baseURL = import.meta.env.VITE_BACKEND_URL || 'https://apna-bazar-backend.vercel.app';
